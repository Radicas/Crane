...
QtLaboratory::QtLaboratory( QWidget* parent ) : QDialog( parent ), m_ui( new Ui::QtLabDlg ), m_scene( new QGraphicsScene() ) {
    initScene();
    initConnects();
}
...
void QtLaboratory::overlapsBtnClicked() {
    QPolygonF polygon;
    polygon << QPointF( -150, -150 ) << QPointF( 150, -150 ) << QPointF( 150, 150 ) << QPointF( -150, 150 ) << QPointF( -150, -150 );
